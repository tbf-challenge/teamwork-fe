        ...
        <div className="wrapper">
          ...
          <div className="question flex mt-20 mb-20 mx-10">
            <div className="flex-1">
              <Typography variant="paragraph" color="blue" className=" FAQ pt-16 pl-16 mb-5 w-26">
                {HelpContent.question}
                {" "}
                <br />
                {" "}
                {HelpContent.question2}
              </Typography>
            </div>
            <div className="flex-1">
          ...
          <div className=" adminMessage flex mt-20 mb-20 ">
            <div className="flex-1">
              ...
              <Typography variant="paragraph" color="black" className="mb-5 w-15">
                {HelpContent.messageText}
                <br />
                {" "}
                {HelpContent.messageText2}
                {" "}
              </Typography>
            </div>
            <div className=" ">
